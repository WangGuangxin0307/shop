            ...
            <div id="covar_list" class="order_list">
                ...
                <div class="list_right_style">
                    <div class="search_style">
                        <form action="index.php?r=order/orderform" method="post">
                            订单编号：<input type="text" name="order_sn" id="order_sn">
                            收货人：<input type="text" name="shipping_user" id="shipping_user">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="sample-table">
                        ...
                        <tr>
                            ...
                            <td class="order_product_name"><?= $value['shipping_user']?></td>
                            <td><?= $value['order_money']?></td>
                            <td><?= $value['district_money']?></td>
                            ...
                            <?php if($value['order_status'] == 0){?>
                                <td class="td-status"><span class="label label-success radius">   代付款 </span></td>
                            <?php }?>
                            ...
                            <?php }?>
                            <td>
                                <a  href="javascript:;" title="发货" id="<?= $value['order_id']?>" class="btn btn-xs btn-success"><i class="fa fa-cubes bigger-120"></i></a>
                                <a title="订单详细"  href="index.php?r=order/detailed&id=<?php echo $value['order_id']?>"  class="btn btn-xs btn-info order_detailed" ><i class="fa fa-list bigger-120"></i></a>
    ...
    <div class="">
        <div class="content_style">
            <div class="form-group"><label class="col-sm-2 control-label no-padding-right" for="form-field-1">快递公司 </label>
                <div class="col-sm-9">
                    <select class="form-control" id="form-field-select-1" name="shipping_comp_name">
                        <option value="0" selected ="selected">--选择快递--</option>
   ...
   $(".btn").on('click',function () {
       ...
       layer.open({
           ...
           yes: function(index, layero){
               var shipping_comp_name = $('#form-field-select-1').val();
               $.ajax({
                   url:'index.php?r=order/stock',
                   data:{order_id:order_id,shipping_comp_name:shipping_comp_name},
                   type:'get',
                   dataType:'json',
