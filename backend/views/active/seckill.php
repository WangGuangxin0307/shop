        ...
        <div class="d_Confirm_Order_style">
            <div class="search_style">
                ...
                <ul class="search_content clearfix">
                    <li><label class="l_f">商品名称</label><input name="" type="text"  class="text_add" placeholder="输入秒杀商品名称"  style=" width:400px"/></li>
                    <li><label class="l_f">秒杀开始时间</label><input class="inline laydate-icon" id="time_begin" style=" margin-left:10px;"></li>
                    <li><label class="l_f">秒杀结束时间</label><input class="inline laydate-icon" id="time_end" style=" margin-left:10px;"></li>
                    <li><label class="l_f">添加时间</label><input class="inline laydate-icon" id="time_create" style=" margin-left:10px;"></li>
...
<div class="add_menber" id="add_menber_style" style="display:none">
    <ul class=" page-content">
        <li>
            <label class="label_name">活动名称：</label>
            <span class="add_name">
                <input value="" name="活动名称" type="text"  class="text_add"/>
            </span>
            <div class="prompt r_f"></div>
        </li>
        <li><label class="label_name">开始时间：</label>
            <input class="inline laydate-icon" id="begin">
            <div class="prompt r_f"></div>
        </li>
        <li><label class="label_name">结束时间：</label>
            <input class="inline laydate-icon" id="end">
            <div class="prompt r_f"></div>
        </li>
        <li class="adderss">
            <label class="label_name">活动描述：</label>
            <span class="add_name">
                <input name="家庭住址" type="text"  class="text_add" style=" width:350px"/></span>
            <div class="prompt r_f"></div>
        </li>
        <li>
